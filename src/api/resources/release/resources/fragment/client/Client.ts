...
export class FragmentClient {
     ...
     * @param {string} id
     * @param {ContentfulViewDelivery.release.GetFragmentRequest} request
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `spaces/${core.url.encodePathParam(spaceId)}/environments/${core.url.encodePathParam(environmentId)}/timeline/fragments/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/spaces/{spaceId}/environments/{environmentId}/timeline/fragments/{id}",
        );
    }
}

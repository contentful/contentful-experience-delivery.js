...
export declare namespace ExperienceFragmentClient {
    export type Options = BaseClientOptions;

    export interface RequestOptions extends BaseRequestOptions {}
}

export class ExperienceFragmentClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<ExperienceFragmentClient.Options>;

    constructor(options: ExperienceFragmentClient.Options) {
     ...
     * @param {string} id
     * @param {ContentfulViewDelivery.GetExperienceFragmentRequest} request
     * @param {ExperienceFragmentClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    ): core.HttpResponsePromise<ContentfulViewDelivery.HydratedExperienceFragmentView> {
    ...
    private async __get(
        ...
        request: ContentfulViewDelivery.GetExperienceFragmentRequest = {},
        requestOptions?: ExperienceFragmentClient.RequestOptions,
    ): Promise<core.WithRawResponse<ContentfulViewDelivery.HydratedExperienceFragmentView>> {
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `spaces/${core.url.encodePathParam(spaceId)}/environments/${core.url.encodePathParam(environmentId)}/experience_fragments/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        if (_response.ok) {
            return {
                data: serializers.HydratedExperienceFragmentView.parseOrThrow(_response.body, {
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/spaces/{spaceId}/environments/{environmentId}/experience_fragments/{id}",
        );
    }
}

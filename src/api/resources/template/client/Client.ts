...
export declare namespace TemplateClient {
...
export class TemplateClient {
    protected readonly _options: NormalizedClientOptionsWithAuth<TemplateClient.Options>;

    constructor(options: TemplateClient.Options) {
     ...
     * @param {string} id
     * @param {ContentfulViewDelivery.GetTemplateRequest} request
     * @param {TemplateClient.RequestOptions} requestOptions - Request-specific configuration.
     *
    ...
    private async __get(
        ...
        const _response = await core.fetcher({
            url: core.url.join(
                ...
                `spaces/${core.url.encodePathParam(spaceId)}/environments/${core.url.encodePathParam(environmentId)}/experience_templates/${core.url.encodePathParam(id)}`,
            ),
            method: "GET",
            headers: _headers,
        ...
        return handleNonStatusCodeError(
            ...
            _response.rawResponse,
            "GET",
            "/spaces/{spaceId}/environments/{environmentId}/experience_templates/{id}",
        );
    }
}
